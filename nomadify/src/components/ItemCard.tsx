            ...
            data?.map((item) => (
                ...
                <div key={item.good_id}>
                    ...
                    <div className="sm:block md:flex gap-5 mb-2 mt-2">
                        <p>Maximum price: <span className="custom_color">$ {item.max}</span></p>
                        <p>Average price: <span className="custom_color">$ {item.avg}</span></p>
                        <p>Minimum price: <span className="custom_color">$ {item.min}</span></p>
                    </div>
