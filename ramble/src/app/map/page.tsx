  ...
  return (
    <>
      <div className="relative">
        <h1 className="flex justify-center xl:text-5xl md:text-2xl sm:text-xl mt-10">
          So, where to?
        </h1>
        <div
          className="cursor-pointer flex absolute bottom-1/4 left-10 z-50 map-tooltip-container"
          data-tooltip-id="nocity-tooltip"
        >
          <ReactTooltip id="nocity-tooltip" openOnClick={true} clickable className="custom-tooltip">
            <NoCity />
          </ReactTooltip>
          <div className="flex">
            <h1>Need help</h1>
