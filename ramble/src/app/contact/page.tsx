    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow flex items-center justify-center relative">
        <Image
          ...
          className="contact-animation object-fit absolute right-0 mr-40"
        />
        <div className="contact-container absolute top-28 left-20">
          <h1 className="lg:text-6xl text-3xl relative">
            Share <span className="custom_font custom_color">ideas</span> with us!
          </h1>
          <form className="relative top-8" onSubmit={sendEmail}>
            ...
            <p className="flex p-10 justify-center">
              Powered with{' '}
              <Link href="/">
                <Image
                  src="/assets/images/nomadify.svg"
                  height={90}
                  width={90}
                  alt="logo"
                  className="ml-3 mt-2"
